...
public class StairsBlockDesign extends AbstractSlopesBlockDesign {
	...
	public StairsBlockDesign(final Plugin plugin, final Texture texture, final SlopeSubTexture slopeTexture) {
