...
import com.timalmdal.bukkit.slopes.designers.SlopedFloorDesign;
...
public final class SlopedFloor extends AbstractBlock {
	...
	public SlopedFloor(final JavaPlugin plugin, final Texture texture, final SlopeSubTexture slopeTexture) {
		super(plugin, slopeTexture.getDisplayName("%s Sloped Floor"), new SlopedFloorDesign(plugin, texture, slopeTexture), texture, slopeTexture);
