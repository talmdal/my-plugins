...
public class IntersectionDesign extends AbstractBlockDesign {
	...
	public IntersectionDesign(final Plugin plugin, final Texture texture, final SlopeSubTexture slopeTexture) {
