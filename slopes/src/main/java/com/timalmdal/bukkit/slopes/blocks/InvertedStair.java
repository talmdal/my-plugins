...
import com.timalmdal.bukkit.slopes.designers.InvertedStairDesign;
import com.timalmdal.bukkit.slopes.util.SlopeSubTexture;

public class InvertedStair extends AbstractBlock {
	public static final String[] RECIPE = new String[] { " AA", "AA ", "A  " };

	public InvertedStair(final JavaPlugin plugin, final Texture texture, final SlopeSubTexture slopeTexture) {
		super(plugin, slopeTexture.getDisplayName("Inverted %s Stairs"),
				new InvertedStairDesign(plugin, texture, slopeTexture), texture, slopeTexture);
