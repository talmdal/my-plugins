...
public class InvertedObliqueSlopeDesign extends GenericBlockDesign {
    public InvertedObliqueSlopeDesign(final Plugin plugin, final Texture tex, final SubTexture subtex) {
        ...
        front.addVertex(1, 1f, 0.5f, 0.5f);
